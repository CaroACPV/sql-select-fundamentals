...
-- En producción es mejor seleccionar solo las columnas necesarias
-- para mejorar el rendimiento y evitar traer datos innecesarios.
...
-- ==========================================
-- El equipo de finanzas solo necesita el cliente,
-- el producto y el monto total de la venta.

SELECT customer_id,  -- COLUMNAS DETERMINADAS
       product_id,
       total_amount
FROM sales;
...
-- ==========================================
-- Consulta 3: Alias con AS
-- ==========================================
-- Se renombran las columnas con nombres más descriptivos
-- para que el reporte sea más fácil de entender.

SELECT order_date AS fecha_pedido,   -- RENOMBRAR COLUMNAS 
